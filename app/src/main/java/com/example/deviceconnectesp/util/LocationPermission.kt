package com.example.deviceconnectesp.util
...
internal fun Context.isLocationPermissionGranted(): Boolean = when {
    ...
    else -> ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED
}
